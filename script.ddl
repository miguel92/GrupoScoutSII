...
CREATE TABLE CUOTA (ID_CUOTA BIGINT NOT NULL, DESCRIPCION VARCHAR(200) NOT NULL, IMPORTE INTEGER NOT NULL, NOMBRE VARCHAR(50) NOT NULL, PRIMARY KEY (ID_CUOTA))
...
CREATE TABLE PAGO_CUOTA (ID_PAGO BIGINT NOT NULL, FECHA DATE NOT NULL, IMPORTE INTEGER NOT NULL, CUOTA_ID_CUOTA BIGINT, SOCIO_id_Usuario BIGINT, PRIMARY KEY (ID_PAGO))
...
CREATE TABLE TRANSACCION (ID_TRANSACCION BIGINT NOT NULL, CONCEPTO VARCHAR(50) NOT NULL, FECHA DATE NOT NULL, IMPORTE INTEGER NOT NULL, SOCIO_id_Usuario BIGINT, PRIMARY KEY (ID_TRANSACCION))
...
ALTER TABLE PAGO_CUOTA ADD CONSTRAINT PGOCUOTACTAIDCUOTA FOREIGN KEY (CUOTA_ID_CUOTA) REFERENCES CUOTA (ID_CUOTA)
